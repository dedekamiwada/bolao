          ...
          <CardContent className="pt-0 space-y-2 text-sm">
            <div className="flex items-start gap-3 py-1.5 border-b">
              ...
              <div>
                ...
                <div className="text-xs text-muted-foreground">Aberta agora · Fecha 15 min antes do 1° jogo</div>
              </div>
            </div>
            <div className="flex items-start gap-3 py-1.5 border-b">
              <div className="w-2 h-2 rounded-full bg-green-400 mt-1.5 shrink-0" />
              <div>
                <div className="font-medium">Rodadas 2 e 3 da Fase de Grupos</div>
                <div className="text-xs text-muted-foreground">Abertas quando todos os jogos da Rodada 1 começarem · Fecham juntas 15 min antes do 1° jogo da Rodada 2</div>
              </div>
            </div>
            <div className="flex items-start gap-3 py-1.5 border-b">
